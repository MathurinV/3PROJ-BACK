...
public interface IUserRepository
{
    ...
    /// <returns>A Task that represents the asynchronous operation. The task will be completed with a boolean value indicating whether the operation was successful (true) or not (false).</returns>
